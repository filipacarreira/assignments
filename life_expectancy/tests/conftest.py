...
COUNTRIES_LIST = ["AT","BE","BG","CH","CY","CZ","DK","EE","EL","ES","FI","FR","HR","HU",
                "IS","IT","LI","LT","LU","LV","MT","NL","NO","PL","PT","RO","SE",
                "SI","SK","DE","DE_TOT","AL","IE","ME","MK","RS",
...
def eu_life_expectancy_raw_tsv() -> pd.DataFrame:
    ...
    dataframe = pd.read_csv(FIXTURES_DIR / "eu_life_expectancy_raw.tsv", sep="\t")
    return dataframe
